...
const Navbar = () => {
  ...
  return (
    <div className="fixed bottom-0 right-0 lg:top-0 lg:mr-3 w-full h-32 lg:h-screen lg:w32 flex justify-center lg:justify-end items-end lg:items-center pb-8 lg:pb-0 z-10 lg:z-0 ">
